...
class BlinkScanDocumentsViewController: UIViewController, BlinkScanDocumentsViewControllerProtocol {
    ...
    func showErrorAlert() {
        let alert = UIAlertController(title: "Error interno", 
                                      message: "A ocurrido un error intenta mas tarde",
    ...
    func startBlinkId() {
        ...
        guard let recognizerRunnerViewController: UIViewController =
                MBViewControllerFactory.recognizerRunnerViewController(withOverlayViewController: 
                                                                        blinkIdOverlayViewController) else {
            return
        }
        recognizerRunnerViewController.modalPresentationStyle = .fullScreen
        self.present(recognizerRunnerViewController, animated: false, completion: nil)
    }
    func startCustomView() {
        ...
        guard let recognizerRunnerViewController: UIViewController =
            MBViewControllerFactory.recognizerRunnerViewController(withOverlayViewController: 
                                                                    customOverlayViewController) else {
                return
        }
        recognizerRunnerViewController.modalPresentationStyle = .fullScreen
...
extension BlinkScanDocumentsViewController: MBBlinkIdOverlayViewControllerDelegate {
    func blinkIdOverlayViewControllerDidFinishScanning(_ blinkIdOverlayViewController: MBBlinkIdOverlayViewController, 
